...
class Token(object):
    ...
    def generate_token(self):
        ...
        if self.token_refreshes <= self.MAX_REFRESHES and self.access_token is not None:
            ...
            url = f"https://fmcrestapisandbox.cisco.com/api/fmc_platform/v1/auth/refreshtoken"
            ...
            url = f"https://fmcrestapisandbox.cisco.com/api/fmc_platform/v1/auth/generatetoken"
...
def getHealthMetrics():
    ...
    """
    # make call
    # url = f"https://fmcrestapisandbox.cisco.com/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/health/alerts?expanded=true
...
def getServerVersion():
    ...
    # make call
    url = f"https://fmcrestapisandbox.cisco.com/api/fmc_platform/v1/info/serverversion?expanded=true"
    logging.info(f"Request: {url}")
...
def getDeviceRecords():
    ...
    # make call
    url = f"https://fmcrestapisandbox.cisco.com/api/fmc_config/v1/domain/e276abec-e0f2-11e3-8169-6d9ed49b625f/devices/devicerecords?expanded=true"
    logging.info(f"Request: {url}")
